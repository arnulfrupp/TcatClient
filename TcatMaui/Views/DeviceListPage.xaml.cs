...
public partial class DeviceListPage : ContentPage
{
    ...
    private void Bluetooth_AdvertisementReceived(object sender, DeviceEventArgs e)
    {
        ...
        else if (e.Device.AdvertisementRecords.Count() == 1)
        {
            if (e.Device.AdvertisementRecords[0].Data.Count() < 2) return;
            if (e.Device.AdvertisementRecords[0].Type != Plugin.BLE.Abstractions.AdvertisementRecordType.ServiceData) return;
            if (e.Device.AdvertisementRecords[0].Data[0] != 251) return;
            if (e.Device.AdvertisementRecords[0].Data[1] != 255) return;
        }
        else return;
